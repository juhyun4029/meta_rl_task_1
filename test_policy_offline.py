...
def test_policy(policy_file, start = 6000., end = 8000., 
    ...
    with tf.Session() as sess:
        ...
        while True:
            ...
            if not done:
                ...
                action_list.append(dic['a_t'][0])
                u_list.append(dic['u_t'][0])
                energy_list.append(dic['Energy'][0]+energy_list[-1])
    ...
    #action_list = np.array(action_list) * 2000. - 2000.
...
def main():
    ...
    for idx in range(0, 1):
        ...
        #load policy
        policy_file = "./model/best/saved_model_summer.ckpt"#+str(idx)+".ckpt"
